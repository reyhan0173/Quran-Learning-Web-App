...
async function fetchAudioUrl(ayahId, reciter) {
...
async function playPauseAudio(buttonElement) {
  ...
  console.log(audioElement.getAttribute('prev_reciter'))
  if (
    ayahId == audioElement.getAttribute('prev_ayah') &&
    reciter == Number(audioElement.getAttribute('prev_reciter'))
  ) {
    ...
    audioElement.src = await fetchAudioUrl(ayahId, reciter);
    audioElement.setAttribute('prev_ayah', ayahId);
    audioElement.setAttribute('prev_ayah_clone', ayahId);
    audioElement.setAttribute('prev_reciter', reciter);
  }
  ...
  audioElement.setAttribute('prev_reciter', 'None');
}
